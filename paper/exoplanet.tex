...
Some work has been done previously to derive the gradients of each component, most notably the \project{starry} project \citep{Luger:2019} that provides that computations.
